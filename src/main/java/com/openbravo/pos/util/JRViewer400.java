 ...
 * @version $Id: JRViewer400.java 2160 2008-04-29 11:31:51Z lucianc $
 */
public final class JRViewer400 extends javax.swing.JPanel implements JRHyperlinkListener
{
	...
	/**
	 * Maximum size (in pixels) of a buffered image that would be used to render a report page.
	 * If rendering a report page would require an image larger than this threshold
	 * (i.e. image width x image height greater maximum size), the report page will be rendered directly on the viewer component.
	...
	public static final String VIEWER_RENDER_BUFFER_MAX_SIZE 
                = JRPropertiesUtil.PROPERTY_PREFIX + "viewer.render.buffer.max.size";
	...
	protected void paintPage(Graphics2D grx)
	{
		...
		catch(Exception e)
		{
			...
			SwingUtilities.invokeLater(new Runnable()
			{
				public void run()
				{
					JOptionPane.showMessageDialog(JRViewer400.this, getBundleString("error.displaying"));
				}
			});
		}
